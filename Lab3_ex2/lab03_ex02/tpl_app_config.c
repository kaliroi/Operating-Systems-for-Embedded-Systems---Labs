 ...
 * Automatically generated by goil on Sun Nov 26 10:57:10 2023
 * from root OIL file lab03_ex02.oil
 *
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm A1200ms : stdAppmode */ ,
  1 /* alarm B2000ms : stdAppmode */ ,
  1 /* alarm C3000ms : stdAppmode */ ,
...
/* Alarm A1200ms identifier */
#define A1200ms_id 0
CONST(AlarmType, AUTOMATIC) A1200ms = A1200ms_id;

/* Alarm B2000ms identifier */
#define B2000ms_id 1
CONST(AlarmType, AUTOMATIC) B2000ms = B2000ms_id;

/* Alarm C3000ms identifier */
#define C3000ms_id 2
CONST(AlarmType, AUTOMATIC) C3000ms = C3000ms_id;
...
CONST(tpl_task_activation_action, OS_CONST) A1200ms_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) A1200ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , A1200ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&A1200ms_action
};
...
VAR(tpl_time_obj, OS_VAR) A1200ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&A1200ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  1172,
    /* date                         */  1172,
...
CONST(tpl_task_activation_action, OS_CONST) B2000ms_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskB_id
...
CONST(tpl_alarm_static, OS_CONST) B2000ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , B2000ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&B2000ms_action
};
...
VAR(tpl_time_obj, OS_VAR) B2000ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&B2000ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  1954,
    /* date                         */  1954,
...
CONST(tpl_task_activation_action, OS_CONST) C3000ms_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskC_id
...
CONST(tpl_alarm_static, OS_CONST) C3000ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , C3000ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&C3000ms_action
};
...
VAR(tpl_time_obj, OS_VAR) C3000ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&C3000ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  2930,
    /* date                         */  2930,
