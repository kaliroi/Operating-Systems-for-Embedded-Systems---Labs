 ...
 * Automatically generated by goil on Thu Nov 16 18:03:17 2023
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  ...
  1 /* alarm Mperiod500ms : stdAppmode */ ,
  1 /* alarm Vperiod125ms : stdAppmode */ ,
...
/* Alarm Mperiod500ms identifier */
#define Mperiod500ms_id 1
CONST(AlarmType, AUTOMATIC) Mperiod500ms = Mperiod500ms_id;

/* Alarm Vperiod125ms identifier */
#define Vperiod125ms_id 2
CONST(AlarmType, AUTOMATIC) Vperiod125ms = Vperiod125ms_id;
...
/*-----------------------------------------------------------------------------
 * Alarm Mperiod500ms descriptor
 *
 * This alarm does the activation of task TaskM
 */
...
CONST(tpl_task_activation_action, OS_CONST) Mperiod500ms_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskM_id
...
CONST(tpl_alarm_static, OS_CONST) Mperiod500ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , Mperiod500ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&Mperiod500ms_action
};
...
VAR(tpl_time_obj, OS_VAR) Mperiod500ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&Mperiod500ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  500,
    /* date                         */  100,
...
CONST(tpl_task_activation_action, OS_CONST) Vperiod125ms_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskV_id
...
CONST(tpl_alarm_static, OS_CONST) Vperiod125ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , Vperiod125ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&Vperiod125ms_action
};
...
VAR(tpl_time_obj, OS_VAR) Vperiod125ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&Vperiod125ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  125,
    /* date                         */  100,
...
CONSTP2VAR(tpl_time_obj, AUTOMATIC, OS_APPL_DATA)
  ...
  &Mperiod500ms_alarm_desc,
  &Vperiod125ms_alarm_desc,
  &stopper_alarm_desc
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
