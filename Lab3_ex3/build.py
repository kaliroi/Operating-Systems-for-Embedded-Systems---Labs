...
#--- OIL file
oilSourceList.append("lab03_ex03.oil")
...
cSourceList.append(projfile.ProjectFile("lab03_ex03.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab03_ex03/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab03_ex03/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab03_ex03/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab03_ex03/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary Lab3_Ex03.hex from Lab3_Ex03")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("Lab3_Ex03")
  postCommand.mCommand.append("Lab3_Ex03.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing Lab3_Ex03 on avr/arduino/uno\033[0m")
